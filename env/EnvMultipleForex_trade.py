...
REWARD_SCALING = 1e-4
print('Enter Forex Trading Environment')
class ForexEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            plt.savefig('results/{}/account_value_trade_{}_{}.png'.format(self.model_name, self.model_name, self.iteration))
            plt.close()
            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv('results/{}/account_value_trade_{}_{}.csv'.format(self.model_name, self.model_name, self.iteration))
            ...
            df_rewards.to_csv('results/{}/account_rewards_trade_{}_{}.csv'.format(self.model_name, self.model_name, self.iteration))
